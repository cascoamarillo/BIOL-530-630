...
# Lab12 BIOL-530-630
You can find the MarkDown Lab online in https://hackmd.io/@frodriguezStudents/ryhRuc87Jg
...
'sudo /usr/local/bin/algo_passwd {student_username}'
...
Go ahead and run:
```
algo /mnt/classes/biol_530_630/bioware/SPAdes-4.0.0-Linux/bin/spades.py -1 frag_1.fastq -2 frag_2.fastq -o Saureus_spadesPE
...
`algo /mnt/classes/biol_530_630/bioware/wgs-7.0/Linux-amd64/bin/fastqToCA -libraryname illuminaPE -technology illumina -reads frag_1.fastq -mates frag_2.fastq -insertsize 180 20 > Reads12.frg`

Then, run Celera Assembler

`algo /mnt/classes/biol_530_630/bioware/wgs-7.0/Linux-amd64/bin/runCA -p Saureus_celera -d Saureus_runCA Reads12.frg -s specFile`
...
You can make a new folder in your /Lab12 working dir and save there all your asssemblies plus reference sequence.
...
`algo /mnt/sde_dir/software/mummer/mummer-4.0.0rc1/nucmer -p Sa_Celera Saureus_ref-genome.fasta Saureus_celera.ctg.fasta`
...
`algo /mnt/sde_dir/software/mummer/mummer-4.0.0rc1/mummerplot -p Sa_Celera --png  Sa_Celera.delta`
...
### Activity12
Create genome comparison plots, organize them into a single PDF file, and give each plot a descriptive title. Explain what each plot illustrates, with the help of your answers to the Discussion12, and the insights it provides. Share your reflections on the results. :)
...
`algo /mnt/sde_dir/software/velvet/velveth Saureus_velvet 31 -shortPaired -fastq frag_1.fastq frag_2.fastq`

where "31' is the kmer length. With Velvet you needd to find tghe optimal k-mer size in your genome/reads combination.

Then, velvetg is the core of Velvet where the de Bruijn graph is built then manipulated.

`algo /mnt/sde_dir/software/velvet/velvetg Saureus_velvet -exp_cov auto -cov_cutoff auto`
